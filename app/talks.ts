...
export default [
  {
    content: '这是一个包含<b>原始视频</b>的动态内容示例。<br>现在支持使用&lt;br&gt;进行换行和使用&lt;b&gt;标签实现加粗。',
  ...
  {
    content: '这是一个包含B站视频的示例。<br><b>注意：</b>抖音相关功能已移除。',
  ...
  {
    content: '这是一个同时包含<b>视频</b>和<b>图片</b>的示例。<br>支持多种媒体格式的展示。',
